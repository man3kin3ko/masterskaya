...
class CallbackRouter:
    ...
    def update_order(self, callback_msg, master):
        _, uuid, status = callback_msg.split("/")
    ...
    def handle_callback(self, callback_msg, master):
        if (callback_msg.startswith("/order")):
            return self.update_order(callback_msg, master)
